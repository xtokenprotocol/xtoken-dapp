...
import { useGetRequiredCollateral } from '../../../hooks/protocol/useGetRequiredCollateral';
...
const MintContainer: React.FC<Props> = ({ currency }) => {
  ...
  const [isShowedBorrowDays] = useState(true);
  ...
  const [tokenToCollarate, setTokenToCollarate] = useState<Asset>(Asset.BUSD);
  ...
  const { value: requiredCollateral } = useGetRequiredCollateral(
    tokenToBorrow,
    tokenToCollarate,
    borrowAmount,
  ...
  return (
    <>
      <FieldGroup label={t(translations.lend.mintContainer.amount)}>
        <AmountField
          value={amount}
      ...
      <div className="row">
        ...
        <div className="col-4">
          <FieldGroup label={t(translations.lend.mintContainer.token)}>
            <FormSelect
        ...
        <div className="col-8">
          <FieldGroup
            label={
              <>
                {t(translations.lend.mintContainer.collateralAmount)}{' '}
      ...
      <div className="d-flex flex-column flex-lg-row justify-content-lg-between align-items-lg-center">
        ...
        <TradeButton
          text={t(translations.lend.mintContainer.mint) + ` ${currency}`}
