...
// import { selectLendBorrowxToken } from './selectors';
...
//   const { address } = yield select(selectLendBorrowxToken);
...
//
//         const hasContract = xToken.contractList.find(contract => {
...
export function* lendBorrowSaga() {
